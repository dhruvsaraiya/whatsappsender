...
class Window(QtGui.QWidget):
    ...
    def send_message_button_clicked(self):
        ...
        if flag:
            ...
            self.proc = Process(target=backend_driver.sendMessages, args=(self.excel_data['columns'], self.excel_data['items'], message, image, self.selected_option, self.connected, self.time_stamp))
            self.proc.start()
